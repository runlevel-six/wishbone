...
func TestClassifyNonProductRecognizesListings(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			url:  "https://www.homedepot.com/s/Ryobi%20cordless%201gallon%20rank%20sprayer?NCNI-5=",
			want: ShapeSearch,
		},
		{
			// Pasted three times in seven minutes. Nothing was ever coming back.
			name: "brand listing",
			url:  "https://www.homedepot.com/b/RYOBI/N-5yc1vZm5d",
			want: ShapeCategory,
		},
		...
		{name: "amazon country host", url: "https://www.amazon.co.uk/s?k=lego", want: ShapeSearch},
		{name: "target search", url: "https://www.target.com/s?searchTerm=lego", want: ShapeSearch},
	...
	cases := []struct{ name, url string }{
		{
			...
			url:  "https://www.homedepot.com/p/RYOBI-ONE-18V-Cordless-Bug-Zapper-P29014BTL/320011852",
		},
		...
		{name: "target product", url: "https://www.target.com/p/lego-set/-/A-79294464"},
		{name: "walmart product", url: "https://www.walmart.com/ip/Cordless-Drill/12345"},
		{name: "lowes product", url: "https://www.lowes.com/pd/RYOBI-Drill/1000123456"},
...
func TestClassifyNonProductAfterNormalization(t *testing.T) {
	for _, raw := range []string{
		"https://www.homedepot.com/b/RYOBI/N-5yc1vZm5d/",
		"HTTPS://WWW.HOMEDEPOT.COM/B/RYOBI/N-5yc1vZm5d",
